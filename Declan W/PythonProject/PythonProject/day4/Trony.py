...
onkey(lambda: p1aim.__init__(-4,  4), 'a')
onkey(lambda: p1aim.__init__(4, 0), 'd')

onkey(lambda: p2aim.__init__(0, 4), '7')
onkey(lambda: p2aim.__init__(0, -4), '8')
onkey(lambda: p2aim.__init__(-4,  4), '9')
onkey(lambda: p2aim.__init__(4, 0), '0')
